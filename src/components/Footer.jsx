  ...
  return (
    <footer className="flex items-center justify-between text-white ml-10 mr-10 mb-20 mt-auto">
      <div className="font-normal flex gap-5 items-center">
        ...
        <img
          src="https://imagepng.org/wp-content/uploads/2018/05/libras-simbolo-liguagem-de-sinais-1.png"
          alt="arrow"
          className="w-10 h-10 fill-white border-2 border-white rounded-sm"
        />
