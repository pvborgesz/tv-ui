...
export default function HomePage() {
    ...
    const apps = [audioAppsBtn, audioFile2, audioFile3, audioFile4, audioFile5, audioFile6]
    const tv = [audioTvAbertaBtn, audioFile7, audioFile8, audioFile9, audioFile10, audioFile11]
    const recomends = [audioRecomendBtn, audioFile12, audioFile13, audioFile14, audioFile15, audioFile16]
