    ...
    <>
      ...
      >
        ...
        <div className="text-2xl flex flex-col justify-center items-center text-white">
          ...
          <div
            onClick={handleClick}
            className="border-2 border-black-700 w-[250px] flex justify-center items-center bg-slate-800 rounded-xl p-3 cursor-pointer hover:bg-zinc-700 hover:scale-105 border-2 transition-all duration-400"
          >
            Não Concordo
          </div>
        </div>
